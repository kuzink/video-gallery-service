...
import static com.kuzin.videogalleryservice.util.FileSystemUtil.getFolderNames;
import static com.kuzin.videogalleryservice.util.FileSystemUtil.getThumbnailFiles;
import static com.kuzin.videogalleryservice.util.FileSystemUtil.getVideoFiles;
import static com.kuzin.videogalleryservice.util.FileSystemUtil.loadThumbnailBytes;
...
public class StartUpDataInitializr {
	...
	private static byte[] getInitialThumbnailBytes(final String thumbnailsLocation,
		...
		if (thumbnails.size() > 0) {
			...
			return loadThumbnailBytes(path);
		}
		return null;
	}
}
